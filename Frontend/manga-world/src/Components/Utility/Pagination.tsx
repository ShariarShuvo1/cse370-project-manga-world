    ...
    for (let i = startPage; i <= endPage; i++) {
      pageNumbers.push(
        <li
          ...
          } hover:bg-opacity-90 hover:text-white cursor-pointer py-2 px-4 text-center hover:border-white border-2 border-gray-600 rounded`}
  ...
  return (
    <div className="flex items-center justify-center mt-8 pb-4">
      <button
        ...
        } me-2 bg-black hover:bg-opacity-75 hover:border-white border-2 border-gray-600 text-white px-4 py-2 rounded`}
      ...
      <button
        ...
        } ms-2 bg-black hover:bg-opacity-75 hover:border-white border-2 border-gray-600 text-white px-4 py-2 rounded`}
        onClick={() => handlePageChange(currentPage + 1)}
